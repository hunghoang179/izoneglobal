<?php
/**
 * IZONE GLOBAL functions and definitions
 *
 ...
 *
 * @package IZONEGLOBAL
 * @subpackage IZONEGLOBAL
 * @since IZONEGLOBAL 1.0
 */
/**
...
if (!function_exists('kt_scripts')) {
    ...
    function kt_scripts() {
        ...
        wp_enqueue_style('kt-style', get_template_directory_uri() . '/css/style.css', array(
            'kt-bootstrap',
            'kt-reset',
            'kt-responsive',
            'kt-animate',
        ...
        wp_enqueue_style('kt-option-3', get_template_directory_uri() . '/css/option3.css', array('kt-style'));

        wp_enqueue_style('kt-option-4', get_template_directory_uri() . '/css/option4.css', array('kt-style'));

        wp_enqueue_style('kt-option-5', get_template_directory_uri() . '/css/option5.css', array('kt-style'));

        wp_enqueue_style('kt-option-6', get_template_directory_uri() . '/css/option6.css', array('kt-style'));

        wp_enqueue_style('kt-option-7', get_template_directory_uri() . '/css/option7.css', array('kt-style'));
...
if (!function_exists('kt_display_result_post')) {
    ...
    function kt_display_result_post() {
        ...
        if (have_posts()) : echo intval($num);
        endif; ?> <?php _e('of', 'kutetheme'); ?> <?php echo intval($wp_query->found_posts); ?> <?php _e('posts', 'kutetheme'); ?> </h2>
        </span>
        <?php
    }
...
function tp_woocommerce_product_htmlsurfix($post_type, $args) {
    if ($post_type === 'product') {
        add_permastruct($post_type, "{$args->rewrite['slug']}/%$post_type%.html", $args->rewrite);
    }
}

add_action('registered_post_type', 'tp_woocommerce_product_htmlsurfix', 20, 2);
