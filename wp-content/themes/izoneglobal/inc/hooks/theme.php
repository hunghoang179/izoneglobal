...
function kt_themne_color(){
    ...
    $main_color = kt_option('main_color','#3A3A3A');
    $bg_color = kt_option('bg_color','#fff');
    $price_color = kt_option('price_color','#C60000');
...
CSS;
    ...
    $vm_text_color = kt_option('vm_text_color','#000');
    $vm_bg_hover_color = kt_option('vm_bg_hover_color','#C60000');
...
CSS;
    ...
    if( $kt_used_header == 1 ){
        ...
        $h1_item_mege_menu_bg_hover_color = kt_option('h1_item_mege_menu_bg_hover_color','#C60000');
        ...
        $h1_topbar_text_hover_color = kt_option('h1_topbar_text_hover_color','#C60000');
...
CSS;
        ...
        if( $kt_used_header == 12 ){
            ...
            $h12_box_category_bg = kt_option('h12_box_category_bg','#C60000');
